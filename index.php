...
<head>
	...
	<style>
	body {
	  background-image: url('file:///C:/xampp/htdocs/perfectcup_COMPLETE/img/baground.png');
            ...
            <div class="box">
                <div class="col-lg-12">
				 ...
				 <div class="col-lg-12">
                    ...
                    <hr class="visible-xs">
                    <p>We are  a diverse group of developers, coaches, designers and, of course, coffee lovers. We mix and match our talents and expertise to create the perfect blend that fits your needs. Because in the end, that is what we want: providing you with the best possible solution for all your digital needs.</p>
                </div>
				<div class="col-lg-12">
                    ...
                    <hr class="visible-xs">
                    <p>So, you got no time to hire but you do need an expert? One of our consultants at Content & Coffee might be the right fit for your team. We have experienced professionals who can help you with your project, right away. Have a look at who’s available at the moment below!</p>
                </div>
            </div>
        </div>
